...
const NUMERIC_KEYS = ["Money", "ScrollTokens", "ScrollMoneyBoost", "Playtime", "DailyStreak", "DailyLastClaim"] as const;
...
const DEFAULT_DATA: PlayerData = {
	...
	ScrollMoneyBoost: 0, // 1 = ×1.25 argent permanent acheté en ScrollToken (§6.27)
